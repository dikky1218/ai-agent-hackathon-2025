...
- その各キーワードから関連するサブトピックをさらに3つ抽出してください。

[出力形式]
{
  "topics": [
     {"keyword": "キーワード1", "sub_topics": ["サブトピック1", "サブトピック2", "サブトピック3"]},
     {"keyword": "キーワード2", "sub_topics": ["サブトピック1", "サブトピック2", "サブトピック3"]},
     {"keyword": "キーワード3", "sub_topics": ["サブトピック1", "サブトピック2", "サブトピック3"]},
  ]
}
""",
    output_key="topics",
...
{
  "topics": [
     {"keyword": "キーワード1", "sub_topics": ["サブトピック1", "サブトピック2", "サブトピック3"], "sentence": "学習内容A"},
     {"keyword": "キーワード2", "sub_topics": ["サブトピック1", "サブトピック2", "サブトピック3"], "sentence": "学習内容B"},
     {"keyword": "キーワード3", "sub_topics": ["サブトピック1", "サブトピック2", "サブトピック3"], "sentence": "学習内容C"},
  ]
}
""",
